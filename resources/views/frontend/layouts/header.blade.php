<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm py-3 sticky-top z-3">
    <div class="container">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-2 mega-menu-column">
                                    ...
                                    <ul>
                                        <li><a href="{{ route('frontend.best-ivf-center-in-mumbai') }}">IVF Center In Mumbai</a></li>
                                        <li><a href="{{ route('frontend.ivf-cost-in-mumbai') }}">IVF Cost In Mumbai</a></li>
                                        <li><a href="{{ route('frontend.iui-treatment-in-mumbai') }}">IUI Treatment In Mumbai</a></li>
                                        <li><a href="{{ route('frontend.imsi-treatment-in-mumbai') }}">IMSI Treatment In Mumbai</a></li>
                                        <li><a href="{{ route('frontend.icsi-treatment-for-infertility') }}">ICSI Treatment For Infertility</a></li>
                                        <li><a href="{{ route('frontend.fertility-evaluation') }}">Fertility Evaluation</a></li>
                                        <li><a href="{{ route('frontend.infertility-work-up') }}">Infertility Work Up</a></li>
                                ...
                                <div class="col-md-3 mega-menu-column">
                                    ...
                                    <ul>
                                        <li><a href="{{ route('frontend.gynecologist-obstetrics-doctors-in-mumbai') }}">Best Gynecologist In Mumbai</a></li>
                                        <li><a href="{{ route('frontend.best-lady-gynecologist-in-mumbai') }}">Best Lady Gynecologist In Mumbai</a></li>
                                        <li><a href="{{ route('frontend.menopause-clinic') }}">Menopause Clinic</a></li>
                                        <li><a href="{{ route('frontend.contraception-counseling') }}">Contraception counseling</a></li>
                                        <li><a href="{{ route('frontend.pcos-treatment-in-mumbai') }}">PCOS Treatment In Mumbai</a></li>
                                    </ul>
                                </div>
                                <!-- FREEZING SERVICES -->
                                <div class="col-md-2 mega-menu-column">
                                ...
                                <div class="col-md-3 mega-menu-column">
                                    ...
                                    <ul>
                                        <li><a href="{{ route('frontend.automated-semen-analyser') }}">Automated Semen Analyser</a></li>
                                        <li><a href="{{ route('frontend.sonography') }}">Comprehensive Sonography</a></li>
                                        <li><a href="{{ route('frontend.laproscopy') }}">Laparoscopy</a></li>
                                        <li><a href="{{ route('frontend.cervical-cancer') }}">Cervical Cancer Screening</a></li>
