...
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <p class="lead text-muted lh-lg">
                    Established in 2017, Pearl Fertility and IVF has been at the forefront of providing comprehensive
                    fertility solutions, offering hope and realizing dreams for couples struggling with infertility. With
                    our state-of-the-art facilities, cutting-edge technology, and a team of highly experienced fertility
                    specialists, we are committed to guiding our patients through every step of their journey towards
                    parenthood.
                </p>
            </div>
        </div>
    ...
    <section class="py-5 bg-pink-subtle text-center">
        <div class="container py-4">
            ...
            <p class="text-muted mt-3">We offer confidential, non-judgmental reproductive health care for people of any
                gender, age & nationality.</p>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container py-4">
            <h2 class="section-title text-center fw-bold">Testimonial Notes</h2>
                    ...
                    <div class="accordion accordion-faq" id="faqAccordion">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    IVF i.e. In vitro fertilization is a procedure where female eggs and male sperm are
                                    fertilized outside the body in a petri dish in a controlled environment.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Broadly IVF is required for male factor infertility from azoospermia and various female
                                    factor infertility conditions like diminished ovarian reserve, defect in fallopian tubes
                                    etc.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    As such, there is no risk because of IVF procedures but there are few anecdotal reports
                                    of increased birth defect with IVF pregnancy.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="py-5 gradient-pink-bg text-center">
        <div class="container py-5">
            <h2 class="fw-bold">Find Useful Information</h2>
            ...
            <div class="row g-4 mt-4 text-start">
                <div class="col-md-4">
                    ...
                    <p class="info-step-text">We give uncommon consideration to the underlying workup for a infertile couple
                        as it permits them to choose the correct sort of fertility treatment dependent on the underlying
                        reports.</p>
                </div>
                <div class="col-md-4">
                    <div class="info-step-number">02</div>
                    <h4 class="info-step-title">Fertility Advice</h4>
                    <p class="info-step-text">Discover the factors influencing fertility, learn about testing procedures,
                        explore treatment choices like IVF and IUI, and find lifestyle tips for optimizing your reproductive
                        health.</p>
                </div>
                <div class="col-md-4">
                    <div class="info-step-number">03</div>
                    <h4 class="info-step-title">Fertility Awareness Method</h4>
                    <p class="info-step-text">Explore the principles of tracking your menstrual cycle, basal body
                        temperature, and cervical mucus to determine your fertile days. This method can be used for both
                        achieving pregnancy. Learn to make informed choices about your reproductive health.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0 rounded overflow-hidden shadow-sm">
                ...
                <div class="col-lg-6">
                    <div class="nutrition-text-box">
                        ...
                        <p class="mt-3">Shyft is a health platform that brings all health & well-being needs to one app.
                            From understanding health - what’s good for you and what’s not, finding the right solutions, to
                            having all your medical records & measuring health vitals in one place - find it all on Shyft!
                            We also provide personalized Nutrition, Yoga and Dermatology services.</p>
                        <div>
    ...
    @if(isset($recent_blogs) && $recent_blogs->count() > 0)
        <section class="py-5 bg-pink-subtle">
            <div class="container py-4">
                <h2 class="section-title text-center mb-2">Recent Blogs</h2>
                <div class="title-underline mb-5"></div>
                <div class="row">
                            ...
                            <div class="card h-100 shadow-sm border-0 bg-white">
                                ...
                                <div class="card-body d-flex flex-column p-4">
                                    <h5 class="card-title fw-bold mb-3">
                                        <a href="{{ route('frontend.blogs.show', $recent->slug) }}"
                                            class="text-dark text-decoration-none">{{ Str::limit($recent->title, 55) }}</a>
                                    </h5>
                                    ...
                                    <a href="{{ route('frontend.blogs.show', $recent->slug) }}"
                                        class="btn btn-outline-primary fw-bold mt-auto align-self-start">Read More</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="text-center mt-5">
                    <a href="{{ route('frontend.blogs.index') }}" class="btn cta-btn">VIEW ALL BLOGS</a>
                </div>
            </div>
        </section>
    @endif
